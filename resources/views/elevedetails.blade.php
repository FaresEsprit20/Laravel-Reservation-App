...
<section class="geView" id="geView">
 ...
 @if ($message = Session::get('edit_eleve_success'))
...
<section class="SeancesTable" id="SeancesTable">
  ...
  <div class="col col-sm col-lg-2">
    ...
    <div class="col-12 col-sm-12 col-lg-8">
      ...
      <div class="locataires-table mt-5 mb-5">
        <div class="table-responsive">
          <table class="table display" id="seanceseleDatatable">
...
<section class="gView" id="gView">
  ...
  @if ($message = Session::get('eleve_facturer_success'))
  <x-bootstrapalertsiconssvg />
 <div class="alert alert-success d-flex align-items-center alert-dismissible fade show" role="alert">
   <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Success:"><use xlink:href="#check-circle-fill"/></svg>
   <div>
...
<section class="GroupesTable" id="GroupeTable">
  ...
  <div class="col col-sm col-lg-2">
    ...
    <div class="col-12 col-sm-12 col-lg-8">
      ...
      <div class="locataires-table mt-5 mb-5">
        <div class="table-responsive">
          <table class="table display" id="faceleDatatable">
            <caption>Liste des Groupes</caption>
            <thead class="table-dark">
